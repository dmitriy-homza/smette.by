...
export default () => {
    ...
    const fetchDataDefault = async () => {
        const result = await firebase.database().ref('trash').once('value').then((snapshot) => snapshot.val());
        setData(result);
      };
      useEffect(() => {
        fetchDataDefault();
    ...
    return (
        <>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Вывоз мусора - Smette</title>
            </Helmet>
            <Layout>
...
мусора
                                ...
                                <div className="table-details desktop">
                                    <h4>Дополнительная информация:</h4>
                                    <p>
                                        Время загрузки - 2 часа, стоимость указана именно за 2 часа (минимальный заказ)
                                    </p>
                                    <p>
...
услуги грузчика - 8-40 руб./ час в зависимости от сложности работ
                                ...
                                <div className="table-details mobile">
                                    <h4>Дополнительная информация:</h4>
                                    <p>
                                        Время загрузки - 2 часа, стоимость указана именно за 2 часа (минимальный заказ)
                                    </p>
                                    <p>
                                        Дополнительное время загрузки: транспорт - 30-60 руб./ час, услуги грузчика - 8-40 руб./ час в зависимости от сложности работ
</p>
                                    <p>Сбор мусора - 1 мешок - 1 рубль</p>
                                </div>
                            </div>
